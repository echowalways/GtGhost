...
TestCase {
    ...
    function test_statuses_0() {
        ...
        verify(inspector_0.nextStatus(sequ_0_0, Ghost.Running))
        ...
        verify(inspector_0.nextStatus(tree_0, Ghost.Running))
        verify(inspector_0.nextStatus(sequ_0_0, Ghost.Running))
        verify(inspector_0.nextStatus(sequ_0_0, Ghost.Failure))
    ...
    function test_statuses_1() {
        ...
        verify(inspector_1.nextStatus(node_1_0_2, Ghost.Success))
        verify(inspector_1.nextStatus(sequ_1_0, Ghost.Success))
        verify(inspector_1.nextStatus(tree_1, Ghost.Success))
        verify(inspector_1.done())

        //
        sequ_1_0.unmatchCount = 300
